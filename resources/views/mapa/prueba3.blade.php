        ...
        <div class="col-3">
            ...
            <div class="row">
                ...
                <div class='mb4'>
                    ...
                    <input type='hidden' id="servicioSelecionado2" name="nom_Servicio2" >
                 
                </div>
                <button onclick="iniciarMapa()">Calcular Ruta</button>
            </div>
...
<script>
    ...
    function iniciarMapa() {
        ...
        var start = new google.maps.LatLng(rutaEnvia[0]);
        console.log(start);
        var end = new google.maps.LatLng(rutaEnvia2);
        var request = {
            origin: start,
            destination: end,
            travelMode: 'DRIVING'
